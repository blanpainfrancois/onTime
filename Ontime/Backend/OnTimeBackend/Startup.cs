...
namespace OnTimeBackend
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            options.UseSqlServer("Server = tcp:ontimesrv.database.windows.net, 1433; Initial Catalog = OnTimeDB; Persist Security Info = False; User ID = OnTimeAdmin; Password = TimeIsMoneyBaby0; MultipleActiveResultSets = False; Encrypt = True; TrustServerCertificate = False; Connection Timeout = 30;")
            );
